package net.waterraid.KitAbilities.LavaFishing;
...
public class LavaFishingHook extends EntityFishingHook {
    ...
    static {
        d = Arrays.asList((new PossibleFishingResult(new ItemStack(Items.LEATHER_BOOTS), 10)).a(0.9F), new PossibleFishingResult(new ItemStack(Items.LEATHER), 10), new PossibleFishingResult(new ItemStack(Items.BONE), 10), new PossibleFishingResult(new ItemStack(Items.POTION), 10), new PossibleFishingResult(new ItemStack(Items.STRING), 5), (new PossibleFishingResult(new ItemStack(Items.FISHING_ROD), 2)).a(0.9F), new PossibleFishingResult(new ItemStack(Items.BOWL), 10), new PossibleFishingResult(new ItemStack(Items.STICK), 5), new PossibleFishingResult(new ItemStack(Items.DYE, 10, EnumColor.BLACK.getInvColorIndex()), 1), new PossibleFishingResult(new ItemStack(Blocks.TRIPWIRE_HOOK), 10), new PossibleFishingResult(new ItemStack(Items.ROTTEN_FLESH), 10));
        e = Arrays.asList(new PossibleFishingResult(new ItemStack(Blocks.WATERLILY), 1), new PossibleFishingResult(new ItemStack(Items.NAME_TAG), 1), new PossibleFishingResult(new ItemStack(Items.SADDLE), 1), (new PossibleFishingResult(new ItemStack(Items.BOW), 1)).a(0.25F).a(), (new PossibleFishingResult(new ItemStack(Items.FISHING_ROD), 1)).a(0.25F).a(), (new PossibleFishingResult(new ItemStack(Items.BOOK), 1)).a());
        f = Arrays.asList(new PossibleFishingResult(new ItemStack(Items.FISH, 1, ItemFish.EnumFish.COD.a()), 60), new PossibleFishingResult(new ItemStack(Items.FISH, 1, ItemFish.EnumFish.SALMON.a()), 25), new PossibleFishingResult(new ItemStack(Items.FISH, 1, ItemFish.EnumFish.CLOWNFISH.a()), 2), new PossibleFishingResult(new ItemStack(Items.FISH, 1, ItemFish.EnumFish.PUFFERFISH.a()), 13));
    }
    public LavaFishingHook(World world) {
        super(world);
    }

    public LavaFishingHook(World world, EntityHuman entityhuman) {
    ...
    public void t_() {
        ...
        if (this.az > 0) {
            ...
            double d6;
            for (Entity o : list) {
                if (o.ad() && (o != this.owner || this.au >= 5)) {
                    float f = 0.3F;
            ...
            if (!this.as) {
                ...
                for (int j = 0; j < b0; ++j) {
                    ...
                    if (this.world.b(axisalignedbb2, Material.WATER) || this.world.b(axisalignedbb2, Material.LAVA)) {
                        d7 += 1.0D / (double) b0;
                    }
                }
    ...
    public int l() {
        if (this.world.isClientSide) {
            ...
            if (this.as) {
                playerFishEvent = new PlayerFishEvent((Player) this.owner.getBukkitEntity(), null, (Fish) this.getBukkitEntity(), PlayerFishEvent.State.IN_GROUND);
                this.world.getServer().getPluginManager().callEvent(playerFishEvent);
                if (playerFishEvent.isCancelled()) {
                    return 0;
                }
            ...
            if (b0 == 0) {
                playerFishEvent = new PlayerFishEvent((Player) this.owner.getBukkitEntity(), null, (Fish) this.getBukkitEntity(), PlayerFishEvent.State.FAILED_ATTEMPT);
    ...
    private ItemStack m() {
        ...
        if (f < f1) {
            ...
            return WeightedRandom.a(this.random, d).a(this.random);
        } else {
            f -= f1;
            if (f < f2) {
                this.owner.b(StatisticList.E);
                return WeightedRandom.a(this.random, e).a(this.random);
            } else {
                this.owner.b(StatisticList.C);
                return WeightedRandom.a(this.random, LavaFishingHook.f).a(this.random);
            }
        }
    }
